      ...
      <section className="mx-auto max-w-5xl px-6 py-16 sm:px-10 sm:py-24">
        <div className="card rounded-3xl p-8 sm:p-16">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#f5f5f7] text-[#0071e3]">
              <svg
                className="h-7 w-7"
                fill="none"
                stroke="currentColor"
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="card rounded-3xl p-6 flex flex-col justify-between">
            <div>
              <div className="mb-4 text-[#0071e3]">
                <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="card rounded-3xl p-6 flex flex-col justify-between">
            <div>
              <div className="mb-4 text-[#0071e3]">
                <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 15a4 4 0 007.879-.121M17.657 8.343a8 8 0 010 11.314m-2.829-2.828a4 4 0 010-5.656m-8.485-.001a4 4 0 015.657 0M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-[#1d1d1f]">
                Offline Ready
