    ...
    <main className="min-h-screen bg-[#f5f5f7] px-6 py-12 text-[#1d1d1f] sm:px-10">
      <section className="mx-auto max-w-4xl">
        ...
        <div className="card mt-6 w-full rounded-2xl p-6 text-lg leading-relaxed text-[#515154] focus:outline-none">
          <p>This Privacy Policy governs the use of the TripBook iOS application (&ldquo;the App&rdquo;), developed by Divianadin Newton. User privacy is a fundamental priority. This policy outlines how information is stored and handled when using the App.</p> 
          ...
          <p className="mt-4">TripBook is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis without any warranties of any kind, either expressed or implied.</p> 
